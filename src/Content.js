...
export const content = {
  Testimonials: {
    ...
    skills: [
      { stack: 'front', name: 'react', img: iconReact },
      { stack: 'front', name: 'Redux', img: iconRedux },
      { stack: 'back', name: 'Express', img: iconExpress },
      { stack: 'back', name: 'NodeJs', img: iconNodeJs },
      { stack: 'back', name: 'MongoDB', img: iconMongoDB },
      { stack: 'back', name: 'Graphql', img: iconGraphql },
      { stack: 'back', name: 'posgreSQL', img: iconPosgreSQL },
      { stack: 'back', name: 'sequelize', img: iconSequelize },
      { stack: 'front', name: 'css', img: iconCss },
      { stack: 'front', name: 'vite', img: iconVite },
      { stack: 'front', name: 'tailwindCSS', img: iconTailwindCSS },
    ],
  },
}
